...
//texture texture2DArray sc_TAAColorTextureArrSC 2:8:2:4
//texture texture2DArray sc_TAAHistoryTextureArrSC 2:10:2:6
//texture texture2DArray sc_TAAMotionVectorTextureArrSC 2:11:2:7
//SG_REFLECTION_END
...
#endif
l9_3=sc_SampleTextureBiasOrLevel(sc_TAAMotionVectorTextureDims.xy,sc_TAAMotionVectorTextureLayout,l9_5,varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_sc_TAAMotionVectorTexture)!=0),sc_TAAMotionVectorTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_sc_TAAMotionVectorTexture,SC_SOFTWARE_WRAP_MODE_V_sc_TAAMotionVectorTexture),(int(SC_USE_UV_MIN_MAX_sc_TAAMotionVectorTexture)!=0),sc_TAAMotionVectorTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_sc_TAAMotionVectorTexture)!=0),sc_TAAMotionVectorTextureBorderColor,0.0,sc_TAAMotionVectorTexture);
}
#endif
vec2 l9_6=decodeMotionVector(l9_3);
vec2 l9_7=varPackedTex.xy-l9_6;
vec4 l9_8;
...
#endif
l9_8=sc_SampleTextureBiasOrLevel(sc_TAAHistoryTextureDims.xy,sc_TAAHistoryTextureLayout,l9_9,l9_7,(int(SC_USE_UV_TRANSFORM_sc_TAAHistoryTexture)!=0),sc_TAAHistoryTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_sc_TAAHistoryTexture,SC_SOFTWARE_WRAP_MODE_V_sc_TAAHistoryTexture),(int(SC_USE_UV_MIN_MAX_sc_TAAHistoryTexture)!=0),sc_TAAHistoryTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_sc_TAAHistoryTexture)!=0),sc_TAAHistoryTextureBorderColor,0.0,sc_TAAHistoryTextureArrSC);
}
#else
{
int l9_10;
...
#endif
l9_8=sc_SampleTextureBiasOrLevel(sc_TAAHistoryTextureDims.xy,sc_TAAHistoryTextureLayout,l9_10,l9_7,(int(SC_USE_UV_TRANSFORM_sc_TAAHistoryTexture)!=0),sc_TAAHistoryTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_sc_TAAHistoryTexture,SC_SOFTWARE_WRAP_MODE_V_sc_TAAHistoryTexture),(int(SC_USE_UV_MIN_MAX_sc_TAAHistoryTexture)!=0),sc_TAAHistoryTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_sc_TAAHistoryTexture)!=0),sc_TAAHistoryTextureBorderColor,0.0,sc_TAAHistoryTexture);
}
#endif
sc_writeFragData0(max(vec4(0.0),vec4((l9_8.xyz*historyWeight)+(l9_0.xyz*colorWeight),1.0)));
}
