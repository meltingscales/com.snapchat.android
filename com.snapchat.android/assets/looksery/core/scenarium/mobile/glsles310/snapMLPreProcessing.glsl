...
//texture texture2DArray screenTextureArrSC 2:2:2:1
//SG_REFLECTION_END
...
{
l9_5=sc_SampleView(screenTextureDims.xy,l9_1,screenTextureLayout,l9_4,screenTextureBias,screenTextureArrSC);
}
#else
{
l9_5=sc_SampleView(screenTextureDims.xy,l9_1,screenTextureLayout,l9_4,screenTextureBias,screenTexture);
}
#endif
l9_3=l9_5;
}
...
#if (screenTextureLayout==2)
{
l9_7=sc_SampleView(screenTextureDims.xy,l9_1,screenTextureLayout,l9_6,0.0,screenTextureArrSC);
}
#else
{
l9_7=sc_SampleView(screenTextureDims.xy,l9_1,screenTextureLayout,l9_6,0.0,screenTexture);
}
#endif
l9_3=l9_7;
}
...
{
l9_8=mix(screenTextureBorderColor,l9_3,vec4(l9_2));
}
#else
{
l9_8=l9_3;
