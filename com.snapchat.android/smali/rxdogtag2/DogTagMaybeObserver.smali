...
.method public static synthetic a(Lrxdogtag2/DogTagMaybeObserver;Ljava/lang/Throwable;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Lrxdogtag2/DogTagMaybeObserver;->lambda$onSuccess$2(Ljava/lang/Throwable;)V

    return-void
.end method

.method public static synthetic b(Lrxdogtag2/DogTagMaybeObserver;Ljava/lang/Throwable;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Lrxdogtag2/DogTagMaybeObserver;->lambda$onError$4(Ljava/lang/Throwable;)V

    return-void
.end method

.method public static synthetic c(Lrxdogtag2/DogTagMaybeObserver;Ljava/lang/Throwable;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Lrxdogtag2/DogTagMaybeObserver;->lambda$onComplete$6(Ljava/lang/Throwable;)V

    return-void
.end method

.method public static synthetic d(Lrxdogtag2/DogTagMaybeObserver;Lio/reactivex/rxjava3/disposables/Disposable;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Lrxdogtag2/DogTagMaybeObserver;->lambda$onSubscribe$1(Lio/reactivex/rxjava3/disposables/Disposable;)V

    return-void
.end method

.method public static synthetic e(Lrxdogtag2/DogTagMaybeObserver;Ljava/lang/Throwable;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Lrxdogtag2/DogTagMaybeObserver;->lambda$onError$5(Ljava/lang/Throwable;)V

    return-void
.end method

.method public static synthetic f(Lrxdogtag2/DogTagMaybeObserver;Ljava/lang/Object;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Lrxdogtag2/DogTagMaybeObserver;->lambda$onSuccess$3(Ljava/lang/Object;)V

    return-void
.end method

.method public static synthetic g(Lrxdogtag2/DogTagMaybeObserver;Ljava/lang/Throwable;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Lrxdogtag2/DogTagMaybeObserver;->lambda$onSubscribe$0(Ljava/lang/Throwable;)V
...
.method public onComplete()V
    ...
    invoke-direct {v0, p0, v1}, Lrxdogtag2/f;-><init>(Lrxdogtag2/DogTagMaybeObserver;I)V

    iget-object v2, p0, Lrxdogtag2/DogTagMaybeObserver;->delegate:Lio/reactivex/rxjava3/core/MaybeObserver;

    new-instance v3, LZC7;

    invoke-direct {v3, v1, v2}, LZC7;-><init>(ILjava/lang/Object;)V

    invoke-static {v0, v3}, Lrxdogtag2/RxDogTag;->guardedDelegateCall(Lrxdogtag2/RxDogTag$NonCheckingConsumer;Ljava/lang/Runnable;)V
...
.method public onSubscribe(Lio/reactivex/rxjava3/disposables/Disposable;)V
    ...
    new-instance v0, Lrxdogtag2/e;

    const/4 v1, 0x1

    invoke-direct {v0, p0, v1}, Lrxdogtag2/e;-><init>(Lrxdogtag2/DogTagMaybeObserver;I)V
