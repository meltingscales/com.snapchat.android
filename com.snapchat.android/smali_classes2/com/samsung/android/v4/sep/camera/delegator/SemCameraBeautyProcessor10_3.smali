.class public Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3$SemEventCallback;,
        Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3$SemCaptureCallBack;,
        Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3$SemEngineCallback;
    }
.end annotation


# static fields
.field private static final TAG:Ljava/lang/String; = "SemCameraBeautyProcessor10_3"
...
.field private mSemCaptureCallBack:Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3$SemCaptureCallBack;

.field private mSemEngineCallback:Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3$SemEngineCallback;

.field private mSemEventCallback:Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3$SemEventCallback;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3;->mSDKCaptureCallback:Lcom/samsung/android/v4/sdk/camera/delegator/AbstractSemCameraEffectProcessor$CaptureCallback;
    ...
    iput-object v0, p0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3;->mServiceInitialized:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static synthetic access$300()Ljava/lang/String;
    ...
    sget-object v0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3;->TAG:Ljava/lang/String;

    return-object v0
.end method

.method public static synthetic access$400(Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3;)Lcom/samsung/android/v4/sdk/camera/delegator/AbstractSemCameraEffectProcessor$EngineCallback;
    .locals 0

    iget-object p0, p0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3;->mSDKEngineCallback:Lcom/samsung/android/v4/sdk/camera/delegator/AbstractSemCameraEffectProcessor$EngineCallback;

    return-object p0
.end method

.method public static synthetic access$500(Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3;)Lcom/samsung/android/v4/sdk/camera/delegator/AbstractSemCameraEffectProcessor$CaptureCallback;
    .locals 0

    iget-object p0, p0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3;->mSDKCaptureCallback:Lcom/samsung/android/v4/sdk/camera/delegator/AbstractSemCameraEffectProcessor$CaptureCallback;

    return-object p0
.end method

.method public static synthetic access$600(Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3;)Ljava/util/concurrent/atomic/AtomicBoolean;
    .locals 0

    iget-object p0, p0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3;->mServiceInitialized:Ljava/util/concurrent/atomic/AtomicBoolean;

    return-object p0
.end method

.method public static synthetic access$700(Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3;)Lcom/samsung/android/v4/sdk/camera/delegator/AbstractSemCameraEffectProcessor$EventCallback;
    .locals 0

    iget-object p0, p0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3;->mSDKEventCallback:Lcom/samsung/android/v4/sdk/camera/delegator/AbstractSemCameraEffectProcessor$EventCallback;
...
.method private setupProcessorConfig(Lcom/samsung/android/v4/sdk/camera/delegator/data/AbstractProcessorConfig;)Lcom/samsung/android/camerasdkservice/data/ProcessorConfig;
    ...
    iget-object v1, p0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3;->mSemEngineCallback:Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3$SemEngineCallback;
    ...
    iget-object v1, p0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3;->mSemEventCallback:Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3$SemEventCallback;
...
.method public buildCaptureRequest(Landroid/hardware/camera2/CaptureRequest$Builder;)Landroid/hardware/camera2/CaptureRequest;
    ...
    iget-object v0, p0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3;->mSemCameraBeautyProcessor:Lcom/samsung/android/sep/camera/SemCameraBeautyProcessor;
...
.method public capture(Landroid/hardware/camera2/CameraCaptureSession;Landroid/hardware/camera2/CaptureResult;Lcom/samsung/android/v4/sdk/camera/delegator/AbstractSemCameraEffectProcessor$CaptureCallback;Landroid/os/Handler;Ljava/util/List;)V
    ...
    iput-object p3, p0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3;->mSDKCaptureCallback:Lcom/samsung/android/v4/sdk/camera/delegator/AbstractSemCameraEffectProcessor$CaptureCallback;
    ...
    iget-object v3, p0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3;->mSemCaptureCallBack:Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3$SemCaptureCallBack;

    invoke-direct {p0, p5}, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3;->getSemParameters(Ljava/util/List;)Ljava/util/List;
...
.method public createSessionConfiguration(Ljava/util/List;Landroid/hardware/camera2/CameraCaptureSession$StateCallback;Landroid/hardware/camera2/CaptureRequest$Builder;Landroid/os/Handler;)Landroid/hardware/camera2/params/SessionConfiguration;
    ...
    :cond_0
    iget-object p1, p0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3;->mSemCameraBeautyProcessor:Lcom/samsung/android/sep/camera/SemCameraBeautyProcessor;
...
.method public deinitialize()V
    ...
    iput-object v0, p0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3;->mSemCaptureCallBack:Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3$SemCaptureCallBack;

    iput-object v0, p0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3;->mSemCameraBeautyProcessor:Lcom/samsung/android/sep/camera/SemCameraBeautyProcessor;

    iput-object v0, p0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3;->mCharacteristics:Landroid/hardware/camera2/CameraCharacteristics;
...
.method public getAvailableCameraConfigParameters()Ljava/util/List;
    ...
    iget-object v1, p0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3;->mSemCameraBeautyProcessor:Lcom/samsung/android/sep/camera/SemCameraBeautyProcessor;
...
.method public getAvailableParameters()Ljava/util/List;
    ...
    iget-object v1, p0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3;->mParameterList:Ljava/util/List;
    ...
    iput-object v1, p0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3;->mParameterList:Ljava/util/List;
    ...
    :cond_4
    iget-object v0, p0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3;->mParameterList:Ljava/util/List;
...
.method public getProcessorParameter(Lcom/samsung/android/v4/sdk/camera/delegator/AbstractSemCameraEffectProcessor$ProcessorParameter;)Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3;->getAvailableParameters()Ljava/util/List;
...
.method public initialize(Lcom/samsung/android/v4/sdk/camera/delegator/data/AbstractProcessorConfig;)V
    ...
    new-instance v0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3$SemCaptureCallBack;

    const/4 v1, 0x0

    invoke-direct {v0, p0, v1}, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3$SemCaptureCallBack;-><init>(Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3;Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3$1;)V
    ...
    iput-object v0, p0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3;->mSDKEngineCallback:Lcom/samsung/android/v4/sdk/camera/delegator/AbstractSemCameraEffectProcessor$EngineCallback;

    new-instance v0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3$SemEngineCallback;

    invoke-direct {v0, p0, v1}, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3$SemEngineCallback;-><init>(Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3;Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3$1;)V

    iput-object v0, p0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3;->mSemEngineCallback:Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3$SemEngineCallback;

    new-instance v0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3$SemEventCallback;

    invoke-direct {v0, p0, v1}, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3$SemEventCallback;-><init>(Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3;Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3$1;)V

    iput-object v0, p0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3;->mSemEventCallback:Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3$SemEventCallback;

    iget-object v0, p0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3;->mSemCameraBeautyProcessor:Lcom/samsung/android/sep/camera/SemCameraBeautyProcessor;

    invoke-direct {p0, p1}, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3;->setupProcessorConfig(Lcom/samsung/android/v4/sdk/camera/delegator/data/AbstractProcessorConfig;)Lcom/samsung/android/camerasdkservice/data/ProcessorConfig;
    ...
    iput-object p1, p0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3;->mSDKEventCallback:Lcom/samsung/android/v4/sdk/camera/delegator/AbstractSemCameraEffectProcessor$EventCallback;
...
.method public setCameraConfigParameter(Landroid/hardware/camera2/CaptureRequest$Builder;Lcom/samsung/android/v4/sdk/camera/delegator/AbstractCameraConfigParameter;Ljava/lang/Object;)Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    :cond_2
    :goto_0
    iget-object p3, p0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBeautyProcessor10_3;->mSemCameraBeautyProcessor:Lcom/samsung/android/sep/camera/SemCameraBeautyProcessor;
