.class public Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4$SemEventCallback;,
        Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4$SemCaptureCallBack;,
        Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4$SemEngineCallback;
    }
.end annotation
...
.field private mSemCaptureCallBack:Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4$SemCaptureCallBack;

.field private mSemEngineCallback:Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4$SemEngineCallback;

.field private mSemEventCallback:Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4$SemEventCallback;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4;->mServiceInitialized:Ljava/util/concurrent/atomic/AtomicBoolean;

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4;->mSDKCaptureCallback:Lcom/samsung/android/v4/sdk/camera/delegator/AbstractSemCameraEffectProcessor$CaptureCallback;
...
.method public static synthetic access$300()Ljava/lang/String;
    ...
    sget-object v0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4;->TAG:Ljava/lang/String;

    return-object v0
.end method

.method public static synthetic access$400(Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4;)Lcom/samsung/android/v4/sdk/camera/delegator/AbstractSemCameraEffectProcessor$EngineCallback;
    .locals 0

    iget-object p0, p0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4;->mSDKEngineCallback:Lcom/samsung/android/v4/sdk/camera/delegator/AbstractSemCameraEffectProcessor$EngineCallback;

    return-object p0
.end method

.method public static synthetic access$500(Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4;)Lcom/samsung/android/v4/sdk/camera/delegator/AbstractSemCameraEffectProcessor$CaptureCallback;
    .locals 0

    iget-object p0, p0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4;->mSDKCaptureCallback:Lcom/samsung/android/v4/sdk/camera/delegator/AbstractSemCameraEffectProcessor$CaptureCallback;

    return-object p0
.end method

.method public static synthetic access$600(Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4;)Ljava/util/concurrent/atomic/AtomicBoolean;
    .locals 0

    iget-object p0, p0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4;->mServiceInitialized:Ljava/util/concurrent/atomic/AtomicBoolean;

    return-object p0
.end method

.method public static synthetic access$700(Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4;)Lcom/samsung/android/v4/sdk/camera/delegator/AbstractSemCameraEffectProcessor$EventCallback;
    .locals 0

    iget-object p0, p0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4;->mSDKEventCallback:Lcom/samsung/android/v4/sdk/camera/delegator/AbstractSemCameraEffectProcessor$EventCallback;
...
.method private setupProcessorConfig(Lcom/samsung/android/v4/sdk/camera/delegator/data/AbstractProcessorConfig;)Lcom/samsung/android/camerasdkservice/data/ProcessorConfig;
    ...
    iget-object v1, p0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4;->mSemEngineCallback:Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4$SemEngineCallback;
    ...
    iget-object v1, p0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4;->mSemEventCallback:Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4$SemEventCallback;
...
.method public buildCaptureRequest(Landroid/hardware/camera2/CaptureRequest$Builder;)Landroid/hardware/camera2/CaptureRequest;
    ...
    iget-object v0, p0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4;->mSemCameraBokehProcessor:Lcom/samsung/android/sep/camera/SemCameraBokehProcessor;
...
.method public capture(Landroid/hardware/camera2/CameraCaptureSession;Landroid/hardware/camera2/CaptureResult;Lcom/samsung/android/v4/sdk/camera/delegator/AbstractSemCameraEffectProcessor$CaptureCallback;Landroid/os/Handler;Ljava/util/List;)V
    ...
    iput-object p3, p0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4;->mSDKCaptureCallback:Lcom/samsung/android/v4/sdk/camera/delegator/AbstractSemCameraEffectProcessor$CaptureCallback;
    ...
    iget-object v3, p0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4;->mSemCaptureCallBack:Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4$SemCaptureCallBack;

    invoke-direct {p0, p5}, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4;->getSemParameters(Ljava/util/List;)Ljava/util/List;
...
.method public createSessionConfiguration(Ljava/util/List;Landroid/hardware/camera2/CameraCaptureSession$StateCallback;Landroid/hardware/camera2/CaptureRequest$Builder;Landroid/os/Handler;)Landroid/hardware/camera2/params/SessionConfiguration;
    ...
    :cond_0
    iget-object p1, p0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4;->mSemCameraBokehProcessor:Lcom/samsung/android/sep/camera/SemCameraBokehProcessor;
...
.method public deinitialize()V
    ...
    iput-object v0, p0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4;->mSemCaptureCallBack:Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4$SemCaptureCallBack;

    iput-object v0, p0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4;->mSemCameraBokehProcessor:Lcom/samsung/android/sep/camera/SemCameraBokehProcessor;
...
.method public getAvailableCameraConfigParameters()Ljava/util/List;
    ...
    iget-object v1, p0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4;->mSemCameraBokehProcessor:Lcom/samsung/android/sep/camera/SemCameraBokehProcessor;
...
.method public getAvailableParameters()Ljava/util/List;
    ...
    iget-object v1, p0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4;->mParameterList:Ljava/util/List;
    ...
    iput-object v1, p0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4;->mParameterList:Ljava/util/List;
    ...
    :cond_4
    iget-object v0, p0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4;->mParameterList:Ljava/util/List;
...
.method public getProcessorParameter(Lcom/samsung/android/v4/sdk/camera/delegator/AbstractSemCameraEffectProcessor$ProcessorParameter;)Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4;->getAvailableParameters()Ljava/util/List;
...
.method public initialize(Lcom/samsung/android/v4/sdk/camera/delegator/data/AbstractProcessorConfig;)V
    ...
    new-instance v0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4$SemCaptureCallBack;

    const/4 v1, 0x0

    invoke-direct {v0, p0, v1}, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4$SemCaptureCallBack;-><init>(Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4;Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4$1;)V
    ...
    iput-object v0, p0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4;->mSDKEngineCallback:Lcom/samsung/android/v4/sdk/camera/delegator/AbstractSemCameraEffectProcessor$EngineCallback;

    new-instance v0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4$SemEngineCallback;

    invoke-direct {v0, p0, v1}, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4$SemEngineCallback;-><init>(Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4;Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4$1;)V

    iput-object v0, p0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4;->mSemEngineCallback:Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4$SemEngineCallback;

    new-instance v0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4$SemEventCallback;

    invoke-direct {v0, p0, v1}, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4$SemEventCallback;-><init>(Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4;Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4$1;)V

    iput-object v0, p0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4;->mSemEventCallback:Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4$SemEventCallback;

    iget-object v0, p0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4;->mSemCameraBokehProcessor:Lcom/samsung/android/sep/camera/SemCameraBokehProcessor;

    invoke-direct {p0, p1}, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4;->setupProcessorConfig(Lcom/samsung/android/v4/sdk/camera/delegator/data/AbstractProcessorConfig;)Lcom/samsung/android/camerasdkservice/data/ProcessorConfig;
    ...
    iput-object p1, p0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4;->mSDKEventCallback:Lcom/samsung/android/v4/sdk/camera/delegator/AbstractSemCameraEffectProcessor$EventCallback;
...
.method public isPreviewVDISSupported(Landroid/hardware/camera2/CameraCharacteristics;)Z
    ...
    invoke-virtual {v0, p1}, Lcom/samsung/android/sep/camera/SemCameraBokehProcessor;->isPreviewVDISSupported(Landroid/hardware/camera2/CameraCharacteristics;)Z
...
.method public isSuperNightSupported(Landroid/hardware/camera2/CameraCharacteristics;)Z
    ...
    invoke-virtual {v0, p1}, Lcom/samsung/android/sep/camera/SemCameraBokehProcessor;->isSuperNightSupported(Landroid/hardware/camera2/CameraCharacteristics;)Z
...
.method public isVideoHDRSupported(Landroid/hardware/camera2/CameraCharacteristics;)Z
    ...
    invoke-virtual {v0, p1}, Lcom/samsung/android/sep/camera/SemCameraBokehProcessor;->isVideoHDRSupported(Landroid/hardware/camera2/CameraCharacteristics;)Z
...
.method public isZoomControllerAvailable(Landroid/hardware/camera2/CameraCharacteristics;)Z
    ...
    invoke-virtual {v0, p1}, Lcom/samsung/android/sep/camera/SemCameraBokehProcessor;->isZoomControllerAvailable(Landroid/hardware/camera2/CameraCharacteristics;)Z
...
.method public setCameraConfigParameter(Landroid/hardware/camera2/CaptureRequest$Builder;Lcom/samsung/android/v4/sdk/camera/delegator/AbstractCameraConfigParameter;Ljava/lang/Object;)Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    :cond_2
    :goto_0
    iget-object p3, p0, Lcom/samsung/android/v4/sep/camera/delegator/SemCameraBokehProcessor10_4;->mSemCameraBokehProcessor:Lcom/samsung/android/sep/camera/SemCameraBokehProcessor;
