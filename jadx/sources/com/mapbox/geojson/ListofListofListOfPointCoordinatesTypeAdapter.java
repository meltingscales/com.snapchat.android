...
class ListofListofListOfPointCoordinatesTypeAdapter extends BaseCoordinatesTypeAdapter<List<List<List<Point>>>> {
    ...
    public List<List<List<Point>>> read(C12054Tab c12054Tab) throws IOException {
        if (c12054Tab.h0() != 9) {
            if (c12054Tab.h0() == 1) {
    ...
    @Override // defpackage.YXl
    public void write(C46590tbb c46590tbb, List<List<List<Point>>> list) throws IOException {
        if (list == null) {
            c46590tbb.F();
            return;
        }
