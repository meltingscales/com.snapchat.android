...
public class SemCameraBeautyProcessor10_3 extends SemCameraEffectProcessor10_3 {
    private static final String TAG = "SemCameraBeautyProcessor10_3";
    ...
    public class SemCaptureCallBack extends SemCaptureCallback {
        ...
        public void onError(int i) {
            String unused = SemCameraBeautyProcessor10_3.TAG;
            if (SemCameraBeautyProcessor10_3.this.mSDKCaptureCallback != null) {
                SemCameraBeautyProcessor10_3.this.mSDKCaptureCallback.onError(i);
            }
        }
        ...
        public void onPictureAvailable(ByteBuffer byteBuffer, int i) {
            ...
            if (SemCameraBeautyProcessor10_3.this.mSDKCaptureCallback != null) {
                SemCameraBeautyProcessor10_3.this.mSDKCaptureCallback.onPictureAvailable(byteBuffer, i);
            }
        }

        public void onShutter() {
            if (SemCameraBeautyProcessor10_3.this.mSDKCaptureCallback != null) {
                SemCameraBeautyProcessor10_3.this.mSDKCaptureCallback.onShutter();
            }
        }
    }
    ...
    public class SemEngineCallback extends SemCameraEffectProcessor.EngineCallback {
        ...
        public void onEngineResult(Bundle bundle) {
            String unused = SemCameraBeautyProcessor10_3.TAG;
            if (SemCameraBeautyProcessor10_3.this.mSDKEngineCallback != null) {
                SemCameraBeautyProcessor10_3.this.mSDKEngineCallback.onEngineResult(bundle);
            }
        }
    }
    ...
    public class SemEventCallback extends ProcessorEventCallback {
        ...
        public void onDeinitialized() {
            if (SemCameraBeautyProcessor10_3.this.mSDKEventCallback != null) {
                SemCameraBeautyProcessor10_3.this.mSDKEventCallback.onDeinitialized();
            }
        }
        ...
        public void onError(int i, String str) {
            ...
            if (i != 1) {
                if (i == 4) {
                    SemCameraBeautyProcessor10_3.this.mServiceInitialized.set(false);
                } else if (i != 5) {
                    String unused2 = SemCameraBeautyProcessor10_3.TAG;
                } else {
                    SemCameraBeautyProcessor10_3.this.mServiceInitialized.set(false);
                    if (SemCameraBeautyProcessor10_3.this.mSDKEventCallback != null) {
                        SemCameraBeautyProcessor10_3.this.mSDKEventCallback.onInitialized();
                    }
                }
            }
        }
        ...
        public void onInitialized() {
            if (SemCameraBeautyProcessor10_3.this.mServiceInitialized.get()) {
                return;
            }
            SemCameraBeautyProcessor10_3.this.mServiceInitialized.set(true);
            if (SemCameraBeautyProcessor10_3.this.mSDKEventCallback != null) {
                SemCameraBeautyProcessor10_3.this.mSDKEventCallback.onInitialized();
            }
        }
    ...
    @Override // com.samsung.android.v4.sep.camera.delegator.SemCameraEffectProcessor10_3, com.samsung.android.v4.sdk.camera.delegator.AbstractSemCameraEffectProcessor
    ...
    @Override // com.samsung.android.v4.sep.camera.delegator.SemCameraEffectProcessor10_3
