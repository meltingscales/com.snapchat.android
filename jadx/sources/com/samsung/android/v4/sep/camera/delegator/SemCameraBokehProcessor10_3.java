...
public class SemCameraBokehProcessor10_3 extends SemCameraEffectProcessor10_3 {
    ...
    public class SemCaptureCallBack extends SemCaptureCallback {
        ...
        public void onError(int i) {
            String unused = SemCameraBokehProcessor10_3.TAG;
            if (SemCameraBokehProcessor10_3.this.mSDKCaptureCallback != null) {
                SemCameraBokehProcessor10_3.this.mSDKCaptureCallback.onError(i);
            }
        }
        ...
        public void onPictureAvailable(ByteBuffer byteBuffer, int i) {
            ...
            if (SemCameraBokehProcessor10_3.this.mSDKCaptureCallback != null) {
                SemCameraBokehProcessor10_3.this.mSDKCaptureCallback.onPictureAvailable(byteBuffer, i);
            }
        }

        public void onShutter() {
            if (SemCameraBokehProcessor10_3.this.mSDKCaptureCallback != null) {
                SemCameraBokehProcessor10_3.this.mSDKCaptureCallback.onShutter();
            }
        }
    }
    ...
    public class SemEngineCallback extends SemCameraEffectProcessor.EngineCallback {
        ...
        public void onEngineResult(Bundle bundle) {
            String unused = SemCameraBokehProcessor10_3.TAG;
            if (SemCameraBokehProcessor10_3.this.mSDKEngineCallback != null) {
                SemCameraBokehProcessor10_3.this.mSDKEngineCallback.onEngineResult(bundle);
            }
        }
    }
    ...
    public class SemEventCallback extends ProcessorEventCallback {
        ...
        public void onDeinitialized() {
            if (SemCameraBokehProcessor10_3.this.mSDKEventCallback != null) {
                SemCameraBokehProcessor10_3.this.mSDKEventCallback.onDeinitialized();
            }
        }
        ...
        public void onError(int i, String str) {
            ...
            if (i != 1) {
                if (i == 4) {
                    SemCameraBokehProcessor10_3.this.mServiceInitialized.set(false);
                } else if (i != 5) {
                    String unused2 = SemCameraBokehProcessor10_3.TAG;
                } else {
                    SemCameraBokehProcessor10_3.this.mServiceInitialized.set(false);
                    if (SemCameraBokehProcessor10_3.this.mSDKEventCallback != null) {
                        SemCameraBokehProcessor10_3.this.mSDKEventCallback.onInitialized();
                    }
                }
            }
        }
        ...
        public void onInitialized() {
            if (SemCameraBokehProcessor10_3.this.mServiceInitialized.get()) {
                return;
            }
            SemCameraBokehProcessor10_3.this.mServiceInitialized.set(true);
            if (SemCameraBokehProcessor10_3.this.mSDKEventCallback != null) {
                SemCameraBokehProcessor10_3.this.mSDKEventCallback.onInitialized();
            }
        }
