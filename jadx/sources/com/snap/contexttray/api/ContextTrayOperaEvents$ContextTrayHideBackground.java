...
public final class ContextTrayOperaEvents$ContextTrayHideBackground extends AbstractC53517y78 {
    public final C51097wXe b;
    public final boolean c;

    public ContextTrayOperaEvents$ContextTrayHideBackground(C51097wXe c51097wXe, boolean z) {
        this.b = c51097wXe;
        this.c = z;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (K1c.m(this.b, contextTrayOperaEvents$ContextTrayHideBackground.b) && this.c == contextTrayOperaEvents$ContextTrayHideBackground.c) {
            return true;
        }
        return false;
    }
