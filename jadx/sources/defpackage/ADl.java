...
public final class ADl implements G1d {
    public static final /* synthetic */ ADl[] b = {new ADl()};
    public final EnumC24456fCe a = EnumC24456fCe.A0;
    /* JADX INFO: Fake field, exist only in values array */
    ADl EF2;

    public static ADl valueOf(String str) {
        return (ADl) Enum.valueOf(ADl.class, str);
    }
