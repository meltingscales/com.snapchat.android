...
public final class BVl extends HVl {
    public final int g;
    public final int h;
    public final int i;
    public final int j;
    ...
    public final boolean equals(Object obj) {
        ...
        BVl bVl = (BVl) obj;
        if (this.g == bVl.g && this.h == bVl.h && this.i == bVl.i && this.j == bVl.j && this.k == bVl.k) {
            return true;
        }
        return false;
    }
    ...
    public final String toString() {
        StringBuilder sb = new StringBuilder("FULL(heightPx=");
        sb.append(this.g);
