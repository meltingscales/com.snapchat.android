...
public final class C0517Au extends a {
    ...
    public C0517Au(ClientProtocol clientProtocol, C27240h14 c27240h14) {
    ...
    public C0517Au(ClientProtocol clientProtocol, INavigator iNavigator, VenueEditorConfig venueEditorConfig, Logging logging, VenueLocationPickerCallback venueLocationPickerCallback, VenueEditorDismissCallback venueEditorDismissCallback, VenuePhotoUpload venuePhotoUpload, VenueEditorAsyncRequestCallback venueEditorAsyncRequestCallback, StaticMapUrlGenerator staticMapUrlGenerator, Function3 function3) {
        this._networkingClient = clientProtocol;
