...
public final class C11144Roj extends AbstractC9878Poj {
    public Boolean l;
    public EnumC53146xsc m;
    public Boolean n;
    public Long o;
    public EnumC2987Erc p;
    public Boolean q;
    public Boolean r;
    public ArrayList s;
    public ArrayList t;
    ...
    public C11144Roj() {
        super("SNAP_KIT_USER_CONNECT", EnumC45985tCg.BUSINESS, 1.0d, 1.0d);
    }
    ...
    public final void c(C38303oC7 c38303oC7, Set set) {
        ...
        AbstractC39604p2m.J0(c38303oC7, 2, bArr, this.n, set);
        ...
        AbstractC39604p2m.R0(c38303oC7, 10, bArr, this.t, set);
        AbstractC39604p2m.R0(c38303oC7, 11, bArr, this.s, set);
        AbstractC39604p2m.L0(c38303oC7, 12, bArr, this.j, set);
        AbstractC39604p2m.M0(c38303oC7, 13, bArr, this.o, set);
        AbstractC39604p2m.L0(c38303oC7, 14, bArr, this.p, set);
        AbstractC39604p2m.J0(c38303oC7, 15, bArr, this.q, set);
        AbstractC39604p2m.J0(c38303oC7, 16, bArr, this.k, set);
