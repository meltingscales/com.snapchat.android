...
public final class C18906baf extends AbstractC23509eaf {
    public final InterfaceC2235Dme b;

    public C18906baf(InterfaceC2235Dme interfaceC2235Dme) {
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof C18906baf)) {
            return false;
        }
        if (K1c.m(this.b, ((C18906baf) obj).b)) {
            return true;
        }
        return false;
    }
    ...
    public final String toString() {
        return "PartiallyVisibleOnEntering(payload=" + this.b + ')';
    }
}
