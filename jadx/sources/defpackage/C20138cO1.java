...
public final class C20138cO1 extends AbstractC13793Vtm {
    public String f;
    public String g;
    public String h;
    public String i;
    ...
    public C20138cO1() {
        super("BUSINESS_EXPERIENCE_APP_FORM_VALIDATION", EnumC45985tCg.BUSINESS, 1.0d, 1.0d);
    }
    ...
    public final int d(Map map) {
        ...
        String str4 = (String) map.get("validation_error_id");
        this.i = str4;
        if (str4 != null) {
            return i + 1;
        }
