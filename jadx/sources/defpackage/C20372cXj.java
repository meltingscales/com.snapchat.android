...
public final class C20372cXj extends SWj {
    public Boolean r;

    public C20372cXj() {
        super("SPECTACLES_PAIRING_SUCCESS", EnumC45985tCg.BUSINESS, 1.0d, 1.0d);
    }
    ...
    public final void c(C38303oC7 c38303oC7, Set set) {
        ...
        AbstractC39604p2m.J0(c38303oC7, 9, bArr, this.r, set);
    ...
    public final int d(Map map) {
        int d = super.d(map);
        Boolean bool = (Boolean) map.get("hevc_mode");
        this.r = bool;
        if (bool != null) {
            return d + 1;
        }
