...
public final class C21444dEl extends C27582hEl {
    public EnumC22978eEl s;

    public C21444dEl() {
        super("TO_SNAPPABLE_INTERRUPT", EnumC45985tCg.BEST_EFFORT, 0.1d, 1.0d);
    }
    ...
    public final int d(Map map) {
        EnumC22978eEl enumC22978eEl;
        int d = super.d(map);
        if (map.containsKey("interrupt_reason")) {
            Object obj = map.get("interrupt_reason");
            if (obj instanceof String) {
                enumC22978eEl = EnumC22978eEl.valueOf((String) obj);
            } else {
                enumC22978eEl = (EnumC22978eEl) obj;
            }
            this.s = enumC22978eEl;
            return d + 1;
        }
        return d;
    }
