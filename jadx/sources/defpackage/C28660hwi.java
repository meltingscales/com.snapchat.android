...
public final class C28660hwi extends AbstractC13793Vtm {
    public String f;
    public String g;
    public EnumC17796ari h;
    public EnumC11263Rti i;
    public Long j;
    public String k;

    public C28660hwi() {
        super("SEND_TO_SELECTION", EnumC45985tCg.BUSINESS, 1.0d, 1.0d);
    }
