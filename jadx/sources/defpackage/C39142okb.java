...
public final class C39142okb extends AbstractC13793Vtm {
    public String f;
    public EnumC40677pkb g;
    public Long h;
    public String i;
    public Boolean j;

    public C39142okb() {
        super("LEGACY_SNAPCODE_MODAL_SNAPCODE_DETECTED", EnumC45985tCg.BUSINESS, 1.0d, 1.0d);
    }
