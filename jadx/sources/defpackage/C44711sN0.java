...
public final class C44711sN0 extends WN0 {
    public String r;
    public String s;
    public String t;
    public Long u;
    ...
    public C44711sN0() {
        super("BACKUP_OPERATION_STEP_ATTEMPT", EnumC45985tCg.BEST_EFFORT, 0.1d, 2);
    }
    ...
    public final void c(C38303oC7 c38303oC7, Set set) {
        ...
        AbstractC39604p2m.O0(c38303oC7, 9, bArr, this.t, set);
        AbstractC39604p2m.O0(c38303oC7, 10, bArr, this.i, set);
        AbstractC39604p2m.M0(c38303oC7, 11, bArr, this.u, set);
        AbstractC39604p2m.M0(c38303oC7, 12, bArr, this.w, set);
        AbstractC39604p2m.M0(c38303oC7, 13, bArr, this.v, set);
        AbstractC39604p2m.O0(c38303oC7, 14, bArr, this.r, set);
        AbstractC39604p2m.O0(c38303oC7, 15, bArr, this.s, set);
        AbstractC39604p2m.O0(c38303oC7, 16, bArr, this.p, set);
        AbstractC39604p2m.M0(c38303oC7, 17, bArr, this.o, set);
        AbstractC39604p2m.J0(c38303oC7, 18, bArr, this.l, set);
        AbstractC39604p2m.M0(c38303oC7, 19, bArr, this.n, set);
        AbstractC39604p2m.O0(c38303oC7, 20, bArr, this.k, set);
        AbstractC39604p2m.M0(c38303oC7, 21, bArr, this.m, set);
        AbstractC39604p2m.J0(c38303oC7, 22, bArr, this.q, set);
        AbstractC39604p2m.M0(c38303oC7, 23, bArr, (Long) this.g, set);
        c38303oC7.j(bArr);
    }
    ...
    public final int d(Map map) {
        ...
        Long l3 = (Long) map.get("step_age_ms");
        this.v = l3;
        if (l3 != null) {
            d++;
        }
