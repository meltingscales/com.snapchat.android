...
public final class C53264xx6 implements InterfaceC50080vsb {
    public final SingleCache a;

    public C53264xx6(InterfaceC9540Pb4 interfaceC9540Pb4) {
        Observable a;
        ...
        ObservableMap observableMap = new ObservableMap(a, AbstractC3403Fig.d(xOb, 15, a));
        Object obj = xOb.a.a;
        if (obj != null) {
            this.a = new SingleCache(new SingleMap(new ObservableElementAtSingle(observableMap, (String) obj), C51731wx6.a));
            return;
        }
        throw new NullPointerException("null cannot be cast to non-null type kotlin.String");
    }

    @Override // defpackage.InterfaceC50080vsb
