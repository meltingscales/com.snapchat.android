...
public enum EFn implements InterfaceC19211bmn {
    UNKNOWN_EVENT(0),
    ...
    CLOUD_SAFE_SEARCH_CLOSE(Tweaks.DELTA_SYNC_SQLITE_SHARED_STORAGE_CACHE_SIZE),
    CLOUD_TEXT_CREATE(121),
    CLOUD_TEXT_DETECT(122),
    CLOUD_TEXT_CLOSE(123),
    CLOUD_WEB_SEARCH_CREATE(Imgproc.COLOR_RGB2YUV_YV12),
    ...
    AGGREGATED_AUTO_ML_IMAGE_LABELING_INFERENCE(AccountManagerConstants.AP_CONFIRM_CREDENTIAL_REQUEST_CODE),
    ...
    @Override // defpackage.InterfaceC19211bmn
    public final int a() {
        return this.a;
    }
}
