...
public final class OOj extends QOj {
    public OOj() {
        super("SPECTACLES_CONTEXT_NOTIFICATION_DISABLE", EnumC45985tCg.BUSINESS, 1.0d, 1.0d);
    }

    @Override // defpackage.QOj, defpackage.InterfaceC42467qug
    public final int b() {
        return 2111;
    }
