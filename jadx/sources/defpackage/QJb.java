...
public final class QJb extends AbstractC16980aKb {
    public final EnumC5668Ixj b;

    public QJb(EnumC5668Ixj enumC5668Ixj) {
        super("MASS_SNAP");
        this.b = enumC5668Ixj;
    }
    ...
    public final String toString() {
        return AbstractC30946jR1.g(new StringBuilder("FromMassSnap(source="), this.b, ')');
    }
}
