...
public enum UOc implements G1d {
    MAP_EDITS_PLACE_ADDED,
    MAP_RECENT_MOVE,
    MAP_FRIEND_TRAVEL_STATUS,
    MAP_LIVE_LOCATION_PAUSE_EXPIRED_ALERT,
    MAP_FRIEND_TRAVEL_STATUS_BACK_IN_TOWN,
    MAP_LIVE_LOCATION_PERMISSION_RECOVERY_ALERT,
    MAP_FRIENDS_UPGRADED_TO_LIVE,
    MAP_REACTION;
    
    public final EnumC24456fCe a = EnumC24456fCe.C0;
