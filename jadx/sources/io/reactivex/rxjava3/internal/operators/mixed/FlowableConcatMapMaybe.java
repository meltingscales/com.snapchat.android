...
public final class FlowableConcatMapMaybe<T, R> extends Flowable<R> {
    ...
    /* loaded from: classes8.dex */
    public static final class ConcatMapMaybeSubscriber<T, R> extends ConcatMapXMainSubscriber<T> implements W0l {
        public long X;
        public int Y;
        public Object Z;
        public final M0l i;
        ...
        public final ConcatMapMaybeObserver t;
        ...
        public static final class ConcatMapMaybeObserver<R> extends AtomicReference<Disposable> implements MaybeObserver<R> {
            ...
            public final void onComplete() {
                ...
                concatMapMaybeSubscriber.y0 = 0;
                concatMapMaybeSubscriber.d();
            }
            ...
            public final void onError(Throwable th) {
                ...
                if (concatMapMaybeSubscriber.a.a(th)) {
                    if (concatMapMaybeSubscriber.c != ErrorMode.c) {
                        concatMapMaybeSubscriber.e.cancel();
                    }
                    concatMapMaybeSubscriber.y0 = 0;
                    concatMapMaybeSubscriber.d();
                }
            ...
            public final void onSuccess(Object obj) {
                ConcatMapMaybeSubscriber concatMapMaybeSubscriber = this.a;
                concatMapMaybeSubscriber.Z = obj;
                concatMapMaybeSubscriber.y0 = 2;
                concatMapMaybeSubscriber.d();
            }
        }

        public ConcatMapMaybeSubscriber(M0l m0l, Function function, int i, ErrorMode errorMode) {
            super(i, errorMode);
            this.i = m0l;
            this.j = function;
            this.k = new AtomicLong();
            this.t = new ConcatMapMaybeObserver(this);
        }
        ...
        @Override // io.reactivex.rxjava3.internal.operators.mixed.ConcatMapXMainSubscriber
        public final void b() {
            ConcatMapMaybeObserver concatMapMaybeObserver = this.t;
        ...
        */
        public final void d() {
            ...
            L6e:
                ...
                io.reactivex.rxjava3.core.MaybeSource r10 = (io.reactivex.rxjava3.core.MaybeSource) r10     // Catch: java.lang.Throwable -> L7e
                r1.y0 = r8
                io.reactivex.rxjava3.internal.operators.mixed.FlowableConcatMapMaybe$ConcatMapMaybeSubscriber$ConcatMapMaybeObserver r11 = r1.t
                r10.subscribe(r11)
                goto Lb9
            L7e:
                r0 = move-exception
            ...
            Lb9:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: io.reactivex.rxjava3.internal.operators.mixed.FlowableConcatMapMaybe.ConcatMapMaybeSubscriber.d():void");
        }
    ...
    public final void F(M0l m0l) {
        this.b.subscribe((FlowableSubscriber) new ConcatMapMaybeSubscriber(m0l, this.c, this.e, this.d));
    }
}
